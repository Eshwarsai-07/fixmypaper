...
export default function ProfessorPage() {
  ...
  return (
    <DashboardShell caption="Professor Dashboard">
      <section className="bg-white border border-line rounded-xl p-8 shadow-sm">
        <h2 className="text-2xl font-serif font-bold mb-2">Institutional Standards</h2>
        <p className="text-[15px] text-ink-soft mb-6 font-medium">
          Define publication expectations and deploy them to research teams instantly.
        </p>
            ...
            <button
              ...
              className={`py-3 text-sm font-semibold transition-colors ${
                tab === t.id
                  ...
                  : "bg-panel-muted text-gray-500 hover:text-brand hover:bg-gray-50"
              }`}
            >
              {t.label}
            </button>
        ...
        {tab === "create" && (
          <div className="animate-fade-in space-y-4">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="w-full py-4 rounded-lg bg-brand text-white text-sm font-bold hover:bg-brand-dark transition-all disabled:opacity-50 shadow-md uppercase tracking-widest"
            >
              {saving ? "Saving Standard…" : "Deploy Institutional Standard"}
            </button>
            {msg && (
              <div
