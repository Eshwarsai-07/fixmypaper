    ...
    Statement = [
      {
        ...
        Effect = "Allow"
        Principal = {
          Service = ["lambda.amazonaws.com", "eks.amazonaws.com"]
        }
      }
    ]
  })
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "*" # Should be specific SFN ARN
      }
    ]
  })
}
    ...
    Statement = [
      {
        ...
        Resource = "*" # Should be specific queue ARN
      },
      {
        Effect = "Allow"
        Action = [
        ...
        Resource = "*" # Should be specific S3 prefix
      },
      {
        Effect = "Allow"
        Action = [
